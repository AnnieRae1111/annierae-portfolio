      ...
      <div className="about-two-container container">
        ...
        <div className="about-text-two">
          <h4>
            ...
            experiences. Skilled in creative problem solving while collaborating
            and communicating with compassion and empathy. A strong believer in
            the importance of learning and forever having a growth mindset.
            Patient problem solver with the ability to multi-task and deliver in
            high pressure, chaotic environments. A professional background in
            artist management, graphic design and social media marketing,
            developing grit, flexibility and a dedicated work ethic.
          </h4>{' '}
        </div>
      </div>
